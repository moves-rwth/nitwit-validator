...
void ldv_set_del(Element e, Set s) {
 ...
 for (m = ({ const typeof((s)->next) __mptr = ((s)->next); (typeof(*m) *)( (char *)__mptr - ((size_t) &((typeof(*m) *)0)->list) );}), n = ({ const typeof((m)->list.next) __mptr = ((m)->list.next); (typeof(*(m)) *)( (char *)__mptr - ((size_t) &((typeof(*(m)) *)0)->list) );}); &m->list != (s); m = n, n = ({ const typeof( ((typeof(*(n)) *)0)->list ) *__mptr = ((n)->list.next); (typeof(*(n)) *)( (char *)__mptr - ((size_t) &((typeof(*(n)) *)0)->list) );})) {
  if(m->e == e) {
   ldv_list_del(&m->list);
   free(m);
  }
...
int ldv_is_in_set(Element e, Set s) {
 struct ldv_list_element *m;
 for (m = ({ const typeof((s)->next) __mptr = ((s)->next); (typeof(*m) *)( (char *)__mptr - ((size_t) &((typeof(*m) *)0)->list) );}); &m->list != (s); m = ({ const typeof((m)->list.next) __mptr = ((m)->list.next); (typeof(*(m)) *)( (char *)__mptr - ((size_t) &((typeof(*(m)) *)0)->list) );})) {
  if(m->e == e) {
   return 1;
  }
 }
