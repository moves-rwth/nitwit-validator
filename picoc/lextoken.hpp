...
enum LexToken
{
    ...
    /* 0x2d */ TokenIdentifier, TokenIntegerConstant, TokenUnsignedIntConstanst, TokenLLConstanst, TokenUnsignedLLConstanst, TokenFloatConstant, TokenDoubleConstant, TokenStringConstant, TokenCharacterConstant,
