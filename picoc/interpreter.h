...
enum LexToken
{
    ...
    /* 0x5d */ TokenAttribute, TokenNoReturn, TokenIgnore,
...
struct Value *ParseFunctionDefinition(struct ParseState *Parser, struct ValueType *ReturnType, char *Identifier, int i);
