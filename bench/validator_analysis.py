...
def get_matching(all_results: List, validators: dict) -> Dict[str, int]:
...
# missing = {}
# else:
# 	with open(os.path.join('../../data/sv-witnesses/witnessInfoByHash', r[1])) as fp:
# 		p = json.load(fp)['producer']
# 		if p == 'CSeq':
# 			print(r[1])
# 			break
# 		emplace_in_dict(missing, p)
# print(missing)
...
def main():
	...
	matching = get_matching(all, validators['byWitnessHash'])
