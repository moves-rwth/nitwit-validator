library(nVennR)
# Load data
setwd("~/Documents/thesis/nitwit/bench")
validators = read.csv('./data.csv') # Don't forget to manually add name of first column as "Witness"
...
showSVG(nVennObj = awesome_venn,
        ...
        fontScale = 0.9,
        labelRegions = T,
        outFile='./output/imgs20/venn_false_custom.svg')
