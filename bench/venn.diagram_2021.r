...
validators = read.csv('./data_2021.csv') # Don't forget to manually add name of first column as "Witness"
...
awesome_venn21 <- plotVenn(list(CPAchecker=cpa, 'Ult. Auto.'=ua,
                              'CPA-w2t'=cpaw2t, 'FShell-w2t'=fshell,
                              NITWIT=cwv),
                nCycles = 100000,
                outFile='./output/imgs2021/venn_false.svg')

showSVG(nVennObj = awesome_venn21,
        opacity = 0.2,
        borderWidth = 1,
        fontScale = 0.9,
        labelRegions = T,
        outFile='./output/imgs2021/venn_false_custom.svg')
